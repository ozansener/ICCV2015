...
\begin{figure}[h!]
  ...
  \caption{Given a large video collection (frames and subtitles) of a category (\eg making an ommelette), we discover activity steps (\eg crack the eggs) with no supervision. We also parse the videos based on the discovered steps.}
  \label{teaser}
  \vspace{-5mm}
\end{figure}
